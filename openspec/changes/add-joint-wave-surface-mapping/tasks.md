...
- [~] 1.5 经人工审核后生成 baseline 并验证 schema 与 engine
  - **RESCINDED — v5 migration attempted but rejected.**  v5 baseline from
    clean 410375b degraded ALL gated metrics vs v4 ratchet
    (quality 8617<8795, coupling 67.78>60.51, god 7>6).
    v4 baseline with corrupted provenance (false sourceCommit b300bb43)
    preserved as fail-closed gate.  SHA256:
    497C0A06E2CC9DD9248B3D2ABF19CF1021D1F596348EE866E1ACDC92F5C325B2
